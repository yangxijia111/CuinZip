...
static void ErrorMessage(LPCWSTR message)
{
  if (!g_DisableUserQuestions)
    ...
    MessageBoxW(NULL, message, L"CuinZip", MB_ICONERROR | MB_OK);
...
static int Main2()
{
  ...
  if (commandStrings.Size() == 0)
  {
    ...
    MessageBoxW(NULL, L"Specify command", L"CuinZip", 0);
    // **************** NanaZip Modification End ****************
    return 0;
  }
  ...
  #ifdef Z7_EXTERNAL_CODECS
  {
    ...
    if (!s.IsEmpty())
    {
      if (!g_DisableUserQuestions)
        ...
        MessageBoxW(NULL, s, L"CuinZip", MB_ICONERROR);
        // **************** NanaZip Modification End ****************
    }
        ...
        || options.Command.IsFromUpdateGroup()))
  {
    ...
    if (!codecs->MainDll_ErrorPath.IsEmpty())
    {
      ...
      UString s("CuinZip cannot load module: ");
      // **************** NanaZip Modification End ****************
